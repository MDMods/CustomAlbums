...
internal static class DataExtensions
{
    ...
    public static int GetIndexByUid(this Il2CppSystem.Collections.Generic.List<IData> dataList, string uid,
        int difficulty)
    {
        var i = 0;
        ...
        {
            if (data.GetUid() == fullUid) return i;
    ...
    public static IData GetIDataByUid(this Il2CppSystem.Collections.Generic.List<IData> dataList, string uid,
        int difficulty)
    {
        var fullUid = $"{uid}_{difficulty}";
