...
internal static class ReportCardPatch
{
    ...
    private static bool Prefix(PnlReportCard __instance)
    {
        ...
        __instance.RefreshRecord(musicInfo, mapDifficulty, save.Score, save.Combo, save.AccuracyStr, save.Evaluate,
            save.Clear.ToString(CultureInfo.InvariantCulture), curMusicBestRankOrder);
        return false;
    }
}
...
internal static class TogglePatch
{
    ...
    private static void Postfix(PnlPreparation __instance)
    {
        ...
        gameObject.SetActive(chart.ContainsKey(mapDifficulty));
    }
}