...
namespace CustomAlbums.Patches
{
    internal class FilterPatch
    {
        ...
        {
            private static bool AllMatchingMeetCondition(string albumName, MusicInfo musicInfo, int starLevel, Func<string, int, bool> condition)
            {
